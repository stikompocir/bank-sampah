...
Public Class Laporan_Periodik1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bank_Sampah.Laporan Periodik1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporan_Periodik1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Laporan_Periodik1 = New Laporan_Periodik1()
        rpt.Site = Me.Site
        Return rpt
    End Function
