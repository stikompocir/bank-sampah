...
Public Class PengambilanTunai
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bank_Sampah.PengambilanTunai.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPengambilanTunai
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PengambilanTunai = New PengambilanTunai()
        rpt.Site = Me.Site
        Return rpt
    End Function
