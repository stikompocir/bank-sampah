...
Public Class Laporan_Nasabah
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bank_Sampah.Laporan Nasabah.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporan_Nasabah
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Laporan_Nasabah = New Laporan_Nasabah()
        rpt.Site = Me.Site
        Return rpt
    End Function
